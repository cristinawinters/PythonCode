...
r = l4.SmartRaster("Landsat_image_corv")  # make sure you have the right raster here
...
# Because it's already set in the function definition, so it defaults to those values if not specified.
